...
//         setIsActive(true)
//         axios
//             .patch(baseUrl + '/api/v1/users/' + `${selectionModel}/`, {username: data.username, first_name: data.firstname, last_name: data.lastname, password:data.password, is_active: isActive}, config)
//             .then((res) => {
//                 swal({
//                     icon: "success",
...
//             {/*          //     const rowsToDelete = datas.filter(item => item.id == row.selectionModel[0]);*/}
//             {/*          //     setSelectionModel(rowsToDelete)*/}
//             {/*          //     console.log(row.selectionModel[0])*/}
...
//                 <DialogTitle id="form-dialog-title">Edit user with ID {selectionModel}</DialogTitle>
//                 <DialogContent>
//                     <form className={classes.form} noValidate
